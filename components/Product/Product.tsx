...
import {declinationOfNumbers, priceRu} from '../../helpers/helpers';
  ...
  return (
    <div className={className} {...props} ref={ref}>
      <Card className={styles.product}>
        ...
        <div
          className={styles.rateTitle}><a href="#ref" onClick={scrollToReview}>{product.reviewCount} {declinationOfNumbers(product.reviewCount, ['отзыв', 'отзыва', 'отзывов'])}</a></div>
